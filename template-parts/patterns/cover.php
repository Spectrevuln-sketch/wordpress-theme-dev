...
<!-- wp:cover {"url":"<?php echo esc_url(ECOMMERCE_BUILD_IMG_URI . '/patterns/cover.jpg') ?>","id":3854,"minHeight":640,"align":"full","className":"ecommerce-cover"} -->
<div class="wp-block-cover alignfull has-background-dim ecommerce-cover" style="background-image:url(<?php echo esc_url(ECOMMERCE_BUILD_IMG_URI . '/patterns/cover.jpg') ?>);min-height:640px">
