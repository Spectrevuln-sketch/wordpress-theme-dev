	...
	public function add_custom_meta_box()
	{
		...
		foreach ($screens as $screen) {
			add_meta_box(
				...
				__('Hide page title', 'ecommerce'),  // Box title
...
?>
		<label for="ecommerce-field"><?php esc_html_e('Hide the page title', 'ecommerce'); ?></label>
		<select name="ecommerce_hide_title_field" id="ecommerce-field" class="postbox">
			<option value=""><?php esc_html_e('Select', 'ecommerce'); ?></option>
			<option value="yes" <?php selected($value, 'yes'); ?>>
				<?php esc_html_e('Yes', 'ecommerce'); ?>
			</option>
			<option value="no" <?php selected($value, 'no'); ?>>
				<?php esc_html_e('No', 'ecommerce'); ?>
			</option>
		</select>
<?php
	}
	...
	public function save_post_meta_data($post_id)
	{
		...
		if (array_key_exists('ecommerce_hide_title_field', $_POST)) {
			update_post_meta(
				$post_id,
				'_hide_page_title',
				$_POST['ecommerce_hide_title_field']
			);
		}
	}
}
