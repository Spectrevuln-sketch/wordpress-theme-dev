...
class Block_Patterns
{
	...
	public function register_block_patterns()
	{
		if (function_exists('register_block_pattern')) {
			...
			register_block_pattern(
				'ecommerce/cover',
				[
					'title' => __('ecommerce Cover', 'ecommerce'),
					'description' => __('ecommerce Cover Block with image and text', 'ecommerce'),
					'categories' => ['cover'],
			...
			register_block_pattern(
				'ecommerce/two-columns',
				[
					'title' => __('ecommerce Two Column', 'ecommerce'),
					'description' => __('ecommerce two columns with heading and text', 'ecommerce'),
					'categories' => ['columns'],
	...
	public function register_block_pattern_categories()
	{
		...
		$pattern_categories = [
			'cover' => __('Cover', 'ecommerce'),
			'columns' => __('Columns', 'ecommerce'),
		];
