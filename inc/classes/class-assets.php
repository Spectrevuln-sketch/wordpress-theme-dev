...
class Assets
{
	...
	public function register_styles()
	{
		...
		wp_register_style('style-custom-css', ECOMMERCE_BUILD_CSS_URI . '/style-custom.css',   [], false, 'all');
		wp_register_style('custom-css', ECOMMERCE_BUILD_CSS_URI . '/custom.css', [], filemtime(ECOMMERCE_BUILD_CSS_DIR_PATH . '/custom.css'), 'all');
		wp_register_style('front-awesome-css', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css');
		wp_register_style('typeahead-css', ECOMMERCE_BUILD_CSS_URI . '/jquery.typeahead.css', [], false, 'all');
		wp_register_style('sumoselect-css', ECOMMERCE_BUILD_CSS_URI . '/sumoselect.css',  [], false, 'all');
		wp_register_style('swiper-css',  ECOMMERCE_BUILD_CSS_URI . '/swiper.css', [], false, 'all');
		wp_register_style('bootstrap-extension-css', ECOMMERCE_BUILD_CSS_URI . '/bootstrap.extension.css',  [], false, 'all');
	...
	public function register_scripts()
	{
		...
		wp_register_script('lokasi-js', 'http://api.iksgroup.co.id/apijs/lokasiapi.js', ['jquery'], false, true);
		...
		wp_register_script('swiper-js', ECOMMERCE_BUILD_JS_URI . '/swiper.jquery.min.js', ['jquery'], false, true);
